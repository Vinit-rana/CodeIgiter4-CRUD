...
$routes->get('temp/(:any)', 'TempController::find/$1');
$routes->get('/students', 'StudentController::index');
$routes->get('/students/insert', 'StudentController::create');
...
$routes->get('/students/confirm-delete/(:num)', 'StudentController::confirm_delete/$1');
